...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {   28.79 ,   28.79 }
    #define DEFAULT_Ki_LIST {   1.91,   1.91 }
    #define DEFAULT_Kd_LIST { 108.51, 108.51 }
  #else
    // Buda 2.0 on 24V
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.5, 100.5, 400, 508 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22, -35, -.6 }
